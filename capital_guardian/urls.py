...
urlpatterns = [
    ...
    path('<slug:slug>/overview/', views.project_overview_view, name='project_overview'),
    path('<slug:slug>/explain/', views.explain_recommendation_view, name='explain_recommendation'),
    path('<slug:slug>/decisions/<int:decision_id>/explain/', views.explain_recommendation_view, name='explain_recommendation_for_decision'),
    ...
    path('<slug:slug>/investigation/', views.investigation_view, name='investigation'),
    ...
    path('<slug:slug>/losses/<int:loss_id>/better-way/view/', views.better_way_view, name='better_way_view'),
    path(
