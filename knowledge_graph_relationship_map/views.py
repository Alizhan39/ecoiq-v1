...
RELATIONSHIP_TYPES = [
    ...
    # Waste-to-Value Capital Allocation Engine relationships
    'ORGANISATION_HAS_OPERATIONAL_LOSS', 'ASSET_HAS_OPERATIONAL_LOSS',
    'LOSS_BACKED_BY_EVIDENCE', 'LOSS_QUANTIFIED_AS_FINANCIAL',
    'LOSS_HAS_INTERVENTION_OPTION', 'INTERVENTION_REDUCES_LOSS',
    'INTERVENTION_HAS_SCENARIO', 'INTERVENTION_HAS_FUNDING_GAP',
    'FUNDING_GAP_MATCHED_TO_ROUTE', 'INTERVENTION_FEEDS_CAPITAL_DECISION',
    'CAPITAL_DECISION_LINKED_TO_COUNCIL_CASE', 'CAPITAL_DECISION_HAS_VERIFIED_OUTCOME',
    'VERIFIED_OUTCOME_GENERATES_REALLOCATION_SIGNAL',
]
