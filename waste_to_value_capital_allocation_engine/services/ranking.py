...
Deterministic weighted composite across the 13 scored dimensions. This
prepares a governed recommendation for human review — it never makes a
financial allocation decision automatically.
"""
RANKING_WEIGHTS = {
    'financial_return':       0.12,
    'capital_efficiency':     0.11,
    'loss_avoided':           0.11,
    'recoverable_value':      0.06,
    'payback':                0.09,  # caller passes an already-inverted "payback speed" goodness score
...
def rank_capital_allocation_options(candidates):
    """
    candidates: list of dicts with the 13 sub-scores (0-100 each, already
