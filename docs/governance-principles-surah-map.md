# EcoIQ Capital Ethics Compendium — Internal Surah Mapping

**INTERNAL ONLY — NOT FOR PUBLIC DISPLAY, API RESPONSES, OR MARKETING**

This document maps the 114 Surahs of the Qur'an to the corresponding
EcoIQ Capital Ethics Compendium governance principles. The public-facing
page at `/governance-principles/` uses professional English principle names only.
No Surah names, Arabic terminology, or Qur'anic references appear in any
public-facing code, API response, or marketing material.

Refer to: `docs/platform-overview.md` (Module 05 language guidance section)
for the full list of approved and prohibited language.

---

## Surah → Principle Mapping

| # | Surah Name | Arabic | Public Principle Title | Category |
|---|---|---|---|---|
| 1 | Al-Fatiha | الفاتحة | Guidance & Purpose | governance |
| 2 | Al-Baqarah | البقرة | Economic Ethics & Contract Integrity | economy |
| 3 | Aal-e-Imran | آل عمران | Community Solidarity & Institutional Resilience | community |
| 4 | An-Nisa | النساء | Protection of Vulnerable Groups | social |
| 5 | Al-Ma'idah | المائدة | Inheritance & Intergenerational Equity | longterm |
| 6 | Al-An'am | الأنعام | Rational Discourse & Evidence Standards | knowledge |
| 7 | Al-A'raf | الأعراف | Moral Courage & Reform | governance |
| 8 | Al-Anfal | الأنفال | War, Conflict & Harm Exclusion | justice |
| 9 | At-Tawbah | التوبة | Ecological Stewardship & Land Ethics | earth |
| 10 | Yunus | يونس | Repentance & Remediation Culture | justice |
| 11 | Hud | هود | Gratitude & Value Recognition | human |
| 12 | Yusuf | يوسف | Architectural & Urban Justice | social |
| 13 | Ar-Ra'd | الرعد | Thunder & Systemic Warning Signals | risk |
| 14 | Ibrahim | إبراهيم | Prosperity & Equitable Distribution | economy |
...
| 22 | Al-Hajj | الحج | Travel, Migration & Human Mobility Rights | social |
| 23 | Al-Mu'minun | المؤمنون | Faith in Process & Procedural Integrity | governance |
| 24 | An-Nur | النور | Light, Vision & Clarity of Purpose | knowledge |
| 25 | Al-Furqan | الفرقان | Criterion & Differentiating Standards | knowledge |
| 26 | Ash-Shu'ara | الشعراء | Poets & Narrative Responsibility | knowledge |
| 27 | An-Naml | النمل | Ants & Collective Intelligence Systems | community |
...
| 54 | Al-Qamar | القمر | Moon & Cyclical Measurement | knowledge |
| 55 | Ar-Rahman | الرحمن | Ecological Balance & Systemic Sustainability | earth |
| 56 | Al-Waqi'ah | الواقعة | The Inevitable & Material Consequence Planning | risk |
| 57 | Al-Hadid | الحديد | Iron & Infrastructure Responsibility | earth |
| 58 | Al-Mujadila | المجادلة | Dispute Resolution & Grievance Mechanisms | justice |
...
| 91 | Ash-Shams | الشمس | The Sun & Energy as Shared Resource | earth |
| 92 | Al-Layl | الليل | The Night & Rest, Recovery & Renewal | human |
...
| 100 | Al-'Adiyat | العاديات | Charging Horses & Competitive Ethics | economy |
| 101 | Al-Qari'ah | القارعة | The Calamity & Catastrophic Risk Planning | risk |
| 102 | At-Takathur | التكاثر | The Race to Good & Competitive Sustainability | longterm |
...
| Category ID | Display Label | Primary Surah Themes |
|---|---|---|
| governance | Governance & Leadership | Leadership, stewardship, accountability, process integrity |
| economy | Wealth, Trade & Fair Economy | Commercial ethics, contracts, extraction, value creation |
| social | Social Protection & Human Dignity | Vulnerable groups, workers, consumers, communities |
| earth | Stewardship of Earth & Resources | Ecology, energy, land, extraction, infrastructure |
| justice | Justice & Accountability | Fairness, harm exclusion, remediation, measurement |
| risk | Risk, Warning & Consequences | Systemic fragility, transition, catastrophic planning |
| knowledge | Knowledge, Evidence & Truth | Evidence standards, documentation, disclosure, narrative |
| human | Mercy & Human Development | Mentorship, dignity, rest, recognition |
| community | Community & Collective Action | Solidarity, consultation, peer accountability |
| longterm | Long-Term Accountability | Intergenerational, patience, transformation, horizons |

---

## Approved vs Prohibited Language (Reminder)

| ✅ Approved in public | ❌ Never in public |
|---|---|
| Capital Ethics Compendium | Qur'an / Quran / Surah |
| governance principles | Islamic governance |
| evidence-based standards | Shariah / Sharia |
| long-term accountability | halal / haram |
| ecological stewardship | fatwa |
| economic ethics | religiously derived |
| analyst signal | faith-based principles |
| assessment metrics | scriptural basis |

---

*Last updated: June 2026*
*Access: Internal team only. Not committed to public branches or shared via API.*
