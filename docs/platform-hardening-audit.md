...
| 13 | Backup & DR | Render backups + PITR (window opens 2026-08-21); one retained logical export; **restore drill passed 2026-08-25** | `docs/runbooks/backup-and-restore.md` | PARTIAL | MED | data restore is proven (374 tables / 30,258 rows exact, 873 constraints validated); **no off-platform copy** and **no Render-hosted cutover rehearsed** | P1 | M | **YES** |
